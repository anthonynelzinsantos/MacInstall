...
brew cask install 1password alfred basictex bbedit coconutbattery displaycal dropbox endurance firefox imageoptim itunes-producer libreoffice musicbrainz-picard qlmarkdown sketch tower xld
