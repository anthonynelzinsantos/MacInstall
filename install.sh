...
brew cask install 1password alfred bbedit coconutbattery displaycal dropbox endurance firefox imageoptim itunes-producer libreoffice mactex musicbrainz-picard qlmarkdown sketch tower xld
